import vertexShaderSource from "./shader_l5/vertexShader.glsl";
import fragmentShaderSource from "./shader_l5/fragmentShader.glsl";
...
function setupTextures(gl: WebGLRenderingContext) {
  ...
  loadImageForTexture("webgl/wood_128x128.jpg", woodTexture);

  const groundTexture = gl.createTexture();
  loadImageForTexture("webgl/wood_floor_256.jpg", groundTexture);

  const boxTexture = gl.createTexture();
  loadImageForTexture("webgl/wicker_256.jpg", boxTexture);
