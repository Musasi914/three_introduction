...
let sphere: THREE.Mesh<THREE.SphereGeometry, THREE.ShaderMaterial, THREE.Object3DEventMap>;
let uniforms: {
  amplitude: {
    value: number;
  };
...
let displacement: Float32Array<ArrayBuffer>;
let noise: Float32Array<ArrayBuffer>;
init();
